...
<div class="max-w-2xl mx-auto">
    ...
    <form action="https://pmosystem-production.up.railway.app/projects" method="POST" class="mt-8 space-y-6">
        ...
        <div class="flex justify-end">
            <a href="{{ route('projects.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                キャンセル
            </a>
