...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('projects', function (Blueprint $table) {
            ...
            // 新しいカラムを追加
            $table->enum('health', ['Green', 'Amber', 'Red'])->default('Green')->after('pm_name'); // 進捗ヘルス
            $table->string('customer_name')->after('health'); // 顧客名
            $table->enum('priority', ['High', 'Medium', 'Low'])->default('Medium')->after('customer_name'); // 優先度
            $table->enum('phase', ['planning', 'requirements', 'design', 'implementation', 'testing', 'release', 'operation'])->default('planning')->after('priority'); // フェーズ
