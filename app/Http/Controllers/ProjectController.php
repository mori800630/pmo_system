...
class ProjectController extends Controller
{
    ...
    private function createDefaultChecklists(Project $project)
    {
        $defaultChecklists = [
            // 計画フェーズ
            ['phase' => 'planning', 'title' => 'プロジェクト内容の理解・共有', 'description' => 'なぜこの案件を実施するのか（背景や経緯）', 'order' => 1],
            ['phase' => 'planning', 'title' => 'プロジェクトのゴールの理解', 'description' => '何を達成したいのか（目的・ゴール・成功の定義）', 'order' => 2],
            ['phase' => 'planning', 'title' => '社内体制の確認', 'description' => '社内での対応体制（PM／BSE／PGなどの役割と担当）', 'order' => 3],
            ['phase' => 'planning', 'title' => '外部委託利用の有無、およびその選定', 'description' => '外部委託利用の有無、およびその選定ができているか？参加する場合、情報共有手段（ドキュメント／会議）は整っているか？', 'order' => 4],
            ['phase' => 'planning', 'title' => '開発メンバーの体制確定', 'description' => '開発メンバーの体制が確定しているか？担当範囲・責任が曖昧な人がいないか？リソースの過不足（偏り）がないか？', 'order' => 5],
            ['phase' => 'planning', 'title' => '関係者間でのQAの実施方法', 'description' => '関係者間でのQAの実施方法は明確か？', 'order' => 6],
            ['phase' => 'planning', 'title' => '関係者間での資料の受け渡し方法', 'description' => '関係者間での資料の受け渡し方法は明確か？', 'order' => 7],
            ['phase' => 'planning', 'title' => '進捗報告のルール、フォーマット決め', 'description' => '進捗報告のルール、フォーマット決めはできているか？', 'order' => 8],
            ['phase' => 'planning', 'title' => '相談相手として相応しい人の確保', 'description' => '相談相手として相応しい人が確保できているか？', 'order' => 9],
            ['phase' => 'planning', 'title' => '仕様決定・最終判断者の明確化', 'description' => '誰が、仕様を決定し、最終判断をするのか？', 'order' => 10],
            ['phase' => 'planning', 'title' => '各メンバーの稼働率', 'description' => 'プロジェクトに関わる人で兼務の人はいるか？どのくらいの稼働率を想定いるのか明確か？', 'order' => 11],
            ['phase' => 'planning', 'title' => '想定スケジュールの明確化', 'description' => '想定スケジュール（開始〜納品まで）は明確か？', 'order' => 12],
            ['phase' => 'planning', 'title' => '継続案件の場合の影響確認', 'description' => '継続案件の場合、前年度からの変更点は明確か？', 'order' => 13],
            ['phase' => 'planning', 'title' => '見積もり・成果物・機能の妥当性検証', 'description' => '成果物や機能（見積もり根拠が算出可能となるレベルで）が明確になっているか', 'order' => 14],
            ['phase' => 'planning', 'title' => '参考にできる過去プロジェクトの確認', 'description' => '過去のプロジェクトで参考にできる資料はあるか？また、経験者等に話を聞いたりすることが可能か？', 'order' => 15],
            ['phase' => 'planning', 'title' => '顧客との合意', 'description' => '品質に関する合意（品質目標・受け入れ条件）が定義され、関係者間で共有・記録されているか？', 'order' => 16],
            ['phase' => 'planning', 'title' => '現時点で見えているリスクの確認', 'description' => '現時点で、『難所だな』と感じる作業はあるか？', 'order' => 17],
            ['phase' => 'planning', 'title' => 'まだ見えていないリスクの確認', 'description' => '『こうなったら困るな』という漠然とした不安はないか？', 'order' => 18],
            ['phase' => 'planning', 'title' => '仕様変更への対応プロセス', 'description' => '仕様変更の起票～影響分析～合意の手順が明文化されているか？責任者・判断基準・記録の運用方針は決まっているか？', 'order' => 19],
            ['phase' => 'planning', 'title' => 'WBS', 'description' => '設計・開発事業者のタスクだけではなく、発注側のタスクも含めたWBSを作成できているか', 'order' => 20],
